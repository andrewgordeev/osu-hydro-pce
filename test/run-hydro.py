...
=======
>>>>>>> 434bb19a9af7b88c84597b24fd69ffa620f6422d
...
<<<<<<< HEAD
    ...
    subprocess.run(['osu-hydro-pce', 'edec=0.1', 't0=0.1', 'teq=0', 'dt={}'.format(dt), 'dxy={}'.format(dxy), 'nls={}'.format(ls), 'tfinal=15.0'],
=======
    dt = 0.01        
    #dt = dxy * dt_ratio
...
<<<<<<< HEAD
profile = np.load('profile13.npy')*3

tspace = np.linspace(0.1, 15.1, 301)
=======
...
# plt.ylabel(r'$\epsilon (GeV/fm^3)$')
# plt.plot(tvals[rvals<2*grid_step], tempvals[rvals<2*grid_step])
=======
# levels = np.arange(0, 400, 1) 
# cmap = plt.cm.jet
# plt.xlabel('x (fm)')
