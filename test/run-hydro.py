...
def run_hydro(fs, event_size, coarse=False, dt_ratio=0.25):
    ...
    subprocess.run(['osu-hydro-pce', 'edec=0.1', 't=0.1', 'teq=5.0', 'dt={}'.format(dt), 'dxy={}'.format(dxy), 'nls={}'.format(ls), 'tfinal=15.0'],  
...
results = run_single_event(profile*2.0/13.0)
